...
app.layout = html.Div(children=[
    ...
    html.Div([
        ...
        html.Div([
                ...
                html.Div('CoApplicant Income (in dollars)'),
...
def prediction_function(Credit_History, LoanAmount, Loan_Amount_Term, ApplicantIncome, CoapplicantIncome,Threshold):
    try:
        data = [[Credit_History, LoanAmount, Loan_Amount_Term, ApplicantIncome, CoapplicantIncome]]
